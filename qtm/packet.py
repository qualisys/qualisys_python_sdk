...
# 2D
RT2DComponent = namedtuple('RT2DComponent',
                           'camera_count drop_rate out_of_sync_rate')
...
# 3D
RT3DComponent = namedtuple('RT3DComponent',
                           'marker_count drop_rate out_of_sync_rate')
...
RT3DMarkerPositionResidual = namedtuple('RT3DMarkerPositionResidual',
                                        'x y z residual')
...
# 6D
RT6DComponent = namedtuple('RT6DComponent',
                           'body_count drop_rate out_of_sync_rate')
...
class QRTEvent(Enum):
    ...
    EventTrigger = 16
    EventNone = 17  # Must be the last. Not actually an event. Just used to count number of events.
...
class QRTPacket(object):
    ...
    def __init__(self, data):
        ...
        for _ in range(component_count):
            ...
            self.components[QRTComponentType(
                c_type)] = position + RTComponentData.size
            position += c_size
    ...
    @component_getter(QRTComponentType.ComponentAnalogSingle,
                      RTAnalogComponent)
    ...
    def get_6d_euler_residual(self,
                              component_info=None,
                              data=None,
                              component_position=None):
    ...
    def get_3d_markers(self,
                       ...
                       component_position=None):
        """Get 3D markers."""
        return self._get_3d_markers(RT3DMarkerPosition, component_info, data,
                                    component_position)

    @component_getter(QRTComponentType.Component3dRes, RT3DComponent)
    def get_3d_markers_residual(self,
                                component_info=None,
                                data=None,
                                component_position=None):
        """Get 3D markers with residual."""
        return self._get_3d_markers(RT3DMarkerPositionResidual, component_info,
                                    data, component_position)
    ...
    def get_3d_markers_no_label(self,
        ...
        return self._get_3d_markers(RT3DMarkerPositionNoLabel, component_info,
                                    data, component_position)

    @component_getter(QRTComponentType.Component3dNoLabelsRes, RT3DComponent)
    def get_3d_markers_no_label_residual(self,
                                         component_info=None,
                                         data=None,
                                         component_position=None):
        """Get 3D markers without label with residual."""
        return self._get_3d_markers(RT3DMarkerPositionNoLabelResidual,
                                    component_info, data, component_position)
    ...
    def get_2d_markers_linearized(self,
                                  component_info=None,
                                  data=None,
                                  component_position=None,
                                  index=None):
