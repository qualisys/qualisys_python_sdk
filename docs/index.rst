...
**NOTE:** Version 2.0 introduces breaking changes. :ref:`More info...<deprecated_version>`
...
This package is a pure python package and requires at least Python 3.5, the easiest way to install it is:
